    ...
    <section className="min-h-screen flex items-center pt-24 pb-16 md:pt-20 md:pb-20">
      <div className="max-w-6xl mx-auto px-6 w-full">
        <div className="flex flex-col items-center text-center gap-6 max-w-2xl mx-auto">
          ...
          {/* Name + title + location */}
          <div className="space-y-2 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-100 ease-out fill-mode-backwards">
          ...
          {/* CTA buttons */}
          <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300 ease-out fill-mode-backwards">
            <a
              href="#projects"
          ...
          {/* Social links */}
          <div className="flex gap-5 pt-2 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-500 ease-out fill-mode-backwards">
